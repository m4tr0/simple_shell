 ...
 * @name: string input representing the name of the environment variable.
 * Return: The value of the specified environment variable, or NULL if it doesn't exist.
*/
 ...
 * @d: string input representing the command to be located.
 * Return: void
 */
int _which(data *d)
{
 ...
 * @d: Flag to determine the behavior
 * @name: variable name
